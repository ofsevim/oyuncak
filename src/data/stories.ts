...
export const STORIES: Story[] = [
  ...
  // ========== YENİ MACERA HİKAYELERİ ==========
  {
    id: "kayip-peri-bahcesi",
    title: "Kayıp Peri Bahçesi",
    tagline: "Bir tohum, bir dilek, sihirli bir bahçe.",
    coverEmoji: "🌿",
    coverGradient: "from-emerald-500/20 via-green-500/10 to-lime-500/20",
    durationLabel: "6-8 dk",
    category: "adventure",
    pages: [
      { title: "Eski Defter", text: "Lara büyükannesinin dolabında eski bir defter buldu. İçinde kurumuş çiçek yaprakları ve garip haritalar vardı.", illustration: "📔" },
      { title: "Sırlı Tarla", text: "Harita, evin arkasındaki terk edilmiş tarlayı gösteriyordu. Büyükannem burada bir peri bahçesi yetiştirirmiş, diye fısıldadı.", illustration: "🗺️" },
      { title: "Toprak Kokusu", text: "Lara toprağa dokundu. Kuru görünüyordu ama parmağının altında bir nem hissetti.", illustration: "🤲" },
      { title: "İlk Tohum", text: "Defterin arasında bir tohum torbası buldu. Üzerinde Dilek Tohumu yazıyordu.", illustration: "🌱", choices: [
        { label: "Toprağa ek 🌱", nextPageIndex: 4 },
        { label: "Suya bandır 💧", nextPageIndex: 5 },
      ]},
      { title: "Ekim", text: "Tohumu dikkatle toprağa koydu ve üzerine hafifçe toprak serpti. Sabırla bekledi.", illustration: "🌱", nextPageIndex: 6 },
      { title: "Sihirli Su", text: "Tohumu bir damla suya bandırdı. Su parladı! Tohum avucunda ısındı.", illustration: "💧", nextPageIndex: 6 },
      { title: "Büyüme", text: "Bir gece içinde tohum filizlendi. Yaprakları ışıl ışıldı. Gerçekten sihirliydi!", illustration: "🌿" },
      { title: "Peri Bahçesi", text: "Sabah kalktığında tarla çiçeklerle doluydu. Kelebekler, arılar, hatta küçük peri kanatları görünüyordu.", illustration: "🦋" },
      { title: "Büyükannenin Sırrı", text: "Büyükannesi gülümsedi: Ben sadece bir tohum ekmiştim. Sen ona sevgi ve sabır verdin.", illustration: "👵" },
      { title: "Mutlu Son", text: "Lara her gün bahçeye baktı. En güzel bahçe, emek verilen bahçedir, dedi.", illustration: "🌺" },
    ],
  },
  {
    id: "gokkusagi-hazine",
    title: "Gökkuşağı Hazinesi",
    tagline: "Renklerin sonunda bir sürpriz var.",
    coverEmoji: "🌈",
    coverGradient: "from-pink-500/20 via-yellow-500/10 to-blue-500/20",
    durationLabel: "6-7 dk",
    category: "adventure",
    pages: [
      { title: "Yağmur Sonrası", text: "Yağmur durdu. Gökyüzünde kocaman bir gökkuşağı belirdi.", illustration: "🌈" },
      { title: "Dilek", text: "Küçük Deniz hayal kurdu: Keşke gökkuşağına tırmanabilsem!", illustration: "💭" },
      { title: "Sihirli Merdiven", text: "Bir anda gökkuşağından merdiven basamakları belirdi. Deniz hayretle baktı.", illustration: "🪜" },
      { title: "Kırmızı Basamak", text: "İlk basamak kırmızıydı. Ayağının altında sıcaklık hissetti.", illustration: "🔴", choices: [
        { label: "Devam et 🟠", nextPageIndex: 4 },
        { label: "Dur ve dinle 🎵", nextPageIndex: 5 },
      ]},
      { title: "Yukarı Tırman", text: "Turuncu, sarı, yeşil... Her basamakta farklı bir his. Deniz mutlu mutlu tırmandı.", illustration: "🟠", nextPageIndex: 6 },
      { title: "Müzik Sesleri", text: "Durduğunda gökkuşağından tatlı bir melodi duydu. Rüzgar çalıyordu!", illustration: "🎵", nextPageIndex: 6 },
      { title: "Zirve", text: "En tepeye ulaştı. Burada küçük bir kutu bekliyordu.", illustration: "📦" },
      { title: "Kutunun İçinde", text: "Kutuyu açtı. İçinde aynası olan bir kutucuk vardı. Aynada kendi yüzü görünüyordu.", illustration: "🪞" },
      { title: "Hazine Sırrı", text: "Arkasında yazılıydı: En büyük hazine, cesaret eden kalptir.", illustration: "✨" },
      { title: "Mutlu Son", text: "Deniz merdivenden indi. Gökkuşağı kayboldu ama aynası hep kaldı.", illustration: "🌅" },
    ],
  },

  // ========== YENİ HAYVAN HİKAYELERİ ==========
  {
    id: "kaplumbaga-yavrusu",
    title: "Kaplumbağa Yavrusunun Yolculuğu",
    tagline: "Yavaş olmak, Pes etmemek demektir.",
    coverEmoji: "🐢",
    coverGradient: "from-teal-500/20 via-emerald-500/10 to-green-500/20",
    durationLabel: "5-7 dk",
    category: "animal",
    pages: [
      { title: "Kumlar Arasında", text: "Küçük kaplumbağa Minik, kumların arasından çıktı. İlk kez dünyayı görüyordu.", illustration: "🥚" },
      { title: "Deniz Uzakta", text: "Deniz çok uzaktı. Diğer yavrular çoktan yüzmeye başlamıştı.", illustration: "🌊" },
      { title: "Yavaş Adımlar", text: "Minik yavaş yürüyordu. Ama hiç durmadı. Küçük adımlarla ilerledi.", illustration: "🐢" },
      { title: "Yengeç Dostu", text: "Bir yengeç yanına geldi: Kaybolma, ben sana yol göstereyim!", illustration: "🦀", choices: [
        { label: "Yengeci takip et 🦀", nextPageIndex: 4 },
        { label: "Kendi yolunu bul 🌟", nextPageIndex: 5 },
      ]},
      { title: "Yengeçle Birlikte", text: "Yengeç ona en kısa yolu gösterdi. Birlikte yürüdüler.", illustration: "🦀", nextPageIndex: 6 },
      { title: "Kendi Yolum", text: "Minik kendi yolunu buldu. Bazen zor oldu ama başardı.", illustration: "🌟", nextPageIndex: 6 },
      { title: "Dalga", text: "Bir dalga geldi ve Minik'i kucakladı. Artık denizdeydi!", illustration: "🌊" },
      { title: "Yüzüş", text: "Minik yüzmeye başladı. Yavaş ama emin adımlarla.", illustration: "🐢" },
      { title: "Açık Deniz", text: "Büyük deniz onu bekliyordu. Minik kendi hızıyla her yere ulaşabilirdi.", illustration: "🐟" },
      { title: "Mutlu Son", text: "Minik öğrendi: Yavaş olmak, durmak demek değildir.", illustration: "💪" },
    ],
  },
  {
    id: "karga-altin",
    title: "Karganın Altın Tanesi",
    tagline: "Gerçek zenginlik, paylaşıldıkça büyür.",
    coverEmoji: "🐦‍⬛",
    coverGradient: "from-slate-500/20 via-gray-500/10 to-zinc-500/20",
    durationLabel: "5-6 dk",
    category: "animal",
    pages: [
      { title: "Parlak Şey", text: "Karga Kara, yerde parlayan bir şey gördü. Bir altın tanesiydi!", illustration: "✨" },
      { title: "Saklamak", text: "Altını gagasına aldı ve gizli bir yere koydu. Kimse görmesin!", illustration: "🐦‍⬛" },
      { title: "Üzgün Komşu", text: "Diğer kuşlar açtı. Yiyecek bulamıyorlardı. Kara utandı.", illustration: "😢" },
      { title: "Düşünme", text: "Kara düşündü: Bu altın tek başına işe yaramaz. Ama...", illustration: "💭", choices: [
        { label: "Altını paylaş 🤝", nextPageIndex: 4 },
        { label: "Takas et 🔄", nextPageIndex: 5 },
      ]},
      { title: "Paylaşım", text: "Altını diğer kuşlara gösterdi. Hepsi birlikte pazardan yemek aldı.", illustration: "🤝", nextPageIndex: 6 },
      { title: "Takas", text: "Altını bir çiftçiyle takas etti. Karşılığında çok fazla buğday aldı.", illustration: "🌾", nextPageIndex: 6 },
      { title: "Birlikte Ziyafet", text: "Tüm kuşlar bir araya geldi. Birlikte yemek yediler.", illustration: "🎉" },
      { title: "Mutlu Son", text: "Kara anladı: Tek başına bir tanede, birlikte koca bir ziyafet var.", illustration: "❤️" },
    ],
  },

  // ========== YENİ UYKU HİKAYELERİ ==========
  {
    id: "deniz-kabugu-fisi",
    title: "Deniz Kabuğu Fısıltısı",
    tagline: "Dinle, deniz sana bir şey söylüyor.",
    coverEmoji: "🐚",
    coverGradient: "from-cyan-500/20 via-blue-500/10 to-indigo-500/20",
    durationLabel: "4-5 dk",
    category: "sleep",
    pages: [
      { title: "Sahil Gecesi", text: "Gece sahildeydin. Yıldızlar denize yansıyordu.", illustration: "🌙" },
      { title: "Kabuk", text: "Elinde parlak bir deniz kabuğu vardı. Kulağına dayadın.", illustration: "🐚" },
      { title: "Fısıltı", text: "Kabuktan hafif bir ses geldi: Uyu... Güvendesin...", illustration: "🌊" },
      { title: "Dalga Sesi", text: "Dalgalar sahile vuruyordu. Ritmik, sakin, güzel.", illustration: "🏖️" },
      { title: "Kumsal", text: "Kumsala uzandın. Kumlar sıcaktı, gece serindi.", illustration: "⭐" },
      { title: "Uyku", text: "Gözlerin kapandı. Rüyanda denizle birlikte yüzdün.", illustration: "😴" },
    ],
  },
  {
    id: "yildiz-kuslari",
    title: "Yıldız Kuşları",
    tagline: "Gökyüzünde seni taşıyan kuşlar var.",
    coverEmoji: "🕊️",
    coverGradient: "from-violet-500/20 via-purple-500/10 to-indigo-500/20",
    durationLabel: "4-5 dk",
    category: "sleep",
    pages: [
      { title: "Gece Gökyüzü", text: "Gökyüzüne baktın. Binlerce yıldız parlıyordu.", illustration: "🌌" },
      { title: "Kuşlar", text: "Yıldızlardan kuşlar doğdu. Işıl ışıl uçuyorlardı.", illustration: "🕊️" },
      { title: "Taşıma", text: "Bir kuş sana kondu. Kanatları yumuşaktı.", illustration: "✨" },
      { title: "Uçuş", text: "Seni gökyüzüne kaldırdı. Bulutların arasında süzüldünüz.", illustration: "☁️" },
      { title: "Yıldız Yuvası", text: "Bir yıldızın üstüne bıraktı. Orası senin yatağın oldu.", illustration: "⭐" },
      { title: "İyi Geceler", text: "Kuşlar etrafında döndü. İyi geceler, dediler.", illustration: "😴" },
    ],
  },

  // ========== YENİ EĞİTİCİ HİKAYELER ==========
  {
    id: "renk-carsisi",
    title: "Renk Çarşısı",
    tagline: "Her rengin bir hikayesi var.",
    coverEmoji: "🎨",
    coverGradient: "from-rose-500/20 via-pink-500/10 to-fuchsia-500/20",
    durationLabel: "6-7 dk",
    category: "education",
    pages: [
      { title: "Boş Tuval", text: "Elinde kocaman bir tuval vardı. Hiçbir renk yoktu.", illustration: "🖼️" },
      { title: "Kırmızı Gelir", text: "Kırmızı ilk geldi: Ben cesaret rengiyim! Kalp gibi.", illustration: "❤️" },
      { title: "Mavi Gelir", text: "Mavi geldi: Ben huzur rengiyim. Deniz ve gökyüzü benim.", illustration: "💙" },
      { title: "Sarı Gelir", text: "Sarı geldi: Ben neşe rengiyim. Güneş gibi parlıyorum!", illustration: "💛", choices: [
        { label: "Yeşili çağır 🟢", nextPageIndex: 4 },
        { label: "Moru çağır 🟣", nextPageIndex: 5 },
      ]},
      { title: "Yeşil Gelir", text: "Yeşil geldi: Ben doğa rengiyim. Ağaçlar benimle büyür.", illustration: "💚", nextPageIndex: 6 },
      { title: "Mor Gelir", text: "Mor geldi: Ben hayal rengiyim. Gökkuşağı benimle başlar.", illustration: "💜", nextPageIndex: 6 },
      { title: "Gökkuşağı", text: "Tüm renkler birleşti. Tuvalde kocaman bir gökkuşağı belirdi.", illustration: "🌈" },
      { title: "Mutlu Son", text: "Her renk güzeldi. Ama birlikte daha güzeldiler.", illustration: "🎨" },
    ],
  },
  {
    id: "sayi-hayvanlari",
    title: "Sayı Hayvanları",
    tagline: "Sayılar hayata geçti!",
    coverEmoji: "🔢",
    coverGradient: "from-blue-500/20 via-cyan-500/10 to-teal-500/20",
    durationLabel: "5-6 dk",
    category: "education",
    pages: [
      { title: "Bir Güzellik", text: "1 tane kuş vardı. Tek başına şarkı söylüyordu.", illustration: "🐦" },
      { title: "İki Dost", text: "2 tane kedi vardı. Birbirine sarılmışlardı.", illustration: "🐱🐱" },
      { title: "Üç Balık", text: "3 tane balık yüzüyordu. Üçü de farklı renkteydi.", illustration: "🐟🐟🐟" },
      { title: "Dört Kelebek", text: "4 tane kelebek dans ediyordu. Kanatları renkliydi.", illustration: "🦋🦋🦋🦋" },
      { title: "Beş Yıldız", text: "5 yıldız parlıyordu. Gökyüzünü süslüyorlardı.", illustration: "⭐⭐⭐⭐⭐" },
      { title: "Sayı Oyunu", text: "Artık sen de say! Etrafındaki her şeyi say.", illustration: "🔢" },
      { title: "Mutlu Son", text: "Sayılar her yerde. Onları bulmak senin elinde.", illustration: "🎉" },
    ],
  },

  // ========== YENİ ARKADAŞLIK HİKAYELERİ ==========
  {
    id: "mektup-arkadasi",
    title: "Mektup Arkadaşlığı",
    tagline: "Bir mektup, bin kilometre, tek dostluk.",
    coverEmoji: "✉️",
    coverGradient: "from-amber-500/20 via-orange-500/10 to-red-500/20",
    durationLabel: "6-7 dk",
    category: "friendship",
    pages: [
      { title: "Boş Defter", text: "Aslı yeni taşındığı şehirde hiç arkadaşı yoktu. Mektup yazmak istedi.", illustration: "📔" },
      { title: "İlk Mektup", text: "Bir mektup yazdı: Merhaba, ben Aslı. Yeni bir şehirdeyim.", illustration: "✍️" },
      { title: "Cevap Geldi", text: "Bir hafta sonra cevap geldi: Merhaba Aslı, ben Defne!", illustration: "📬" },
      { title: "Mektuplaşma", text: "Her hafta mektuplaştılar. Fotoğraf, çiçek yaprağı, küçücük hediyeler gönderdiler.", illustration: "💌", choices: [
        { label: "Ziyarete git ✈️", nextPageIndex: 4 },
        { label: "Video konuş 📱", nextPageIndex: 5 },
      ]},
      { title: "Ziyaret", text: "Aslı Defne'yi ziyarete gitti. Sarıldılar. İlk kez yüz yüze gördüler!", illustration: "🤗", nextPageIndex: 6 },
      { title: "Görüntülü", text: "Ekran karşısında konuştular. Gülüyor, şaka yapıyorlardı.", illustration: "📱", nextPageIndex: 6 },
      { title: "Dostluk", text: "Mesafe önemli değildi. Kalpleri birlikteydi.", illustration: "❤️" },
      { title: "Mutlu Son", text: "Aslı öğrendi: Gerçek arkadaşlık, mesafe tanımaz.", illustration: "✨" },
    ],
  },
  {
    id: "takim-ruhu",
    title: "Takım Ruhu",
    tagline: "Birlikte çalışınca her şey mümkün.",
    coverEmoji: "⚽",
    coverGradient: "from-green-500/20 via-emerald-500/10 to-teal-500/20",
    durationLabel: "5-6 dk",
    category: "friendship",
    pages: [
      { title: "Maç Günü", text: "Okul futbol turnuvası vardı. Takım heyecanlıydı.", illustration: "⚽" },
      { title: "İlk Yarı", text: "Rakip takım çok güçlüydü. İlk yarıyı 2-0 geride bitirdiler.", illustration: "😟" },
      { title: "Soyunma Odası", text: "Kaptan Ege dedi: Birlikte oynarsak kazanırız!", illustration: "🗣️" },
      { title: "İkinci Yarı", text: "İkinci yarıda birlikte oynadılar. Paslaştılar, desteklediler.", illustration: "🤝" },
      { title: "Gol!", text: "Deniz gol attı! 2-1! Herkes sevindi.", illustration: "⚽", choices: [
        { label: "Devam et 💪", nextPageIndex: 5 },
        { label: "Son atak 🏃", nextPageIndex: 6 },
      ]},
      { title: "Beraberlik", text: "Son dakikada beraberlik golü geldi! 2-2!", illustration: "🎉", nextPageIndex: 7 },
      { title: "Galibiyet", text: "Uzatmalarda gol attılar! 3-2 kazandılar!", illustration: "🏆", nextPageIndex: 7 },
      { title: "Takım Ruhu", text: "Kazanmak güzeldi ama birlikte olmak daha güzeldi.", illustration: "❤️" },
    ],
  },
  {
    id: "kutup-yildizi",
    title: "Kutup Yıldızı Arkadaşlığı",
    tagline: "Yalnız yıldız, yol gösteren dost.",
    coverEmoji: "🌟",
    coverGradient: "from-indigo-500/20 via-blue-500/10 to-cyan-500/20",
    durationLabel: "5-6 dk",
    category: "friendship",
    pages: [
      { title: "Küçük Yıldız", text: "Gökyüzünde küçük bir yıldız parlıyordu. Ama çok yalnızdı.", illustration: "⭐" },
      { title: "Diğer Yıldızlar", text: "Büyük yıldızlar ona Gulmezdi: Sen çok küçüksün, derlerdi.", illustration: "🌌" },
      { title: "Kaybolmuş Çocuk", text: "Aşağıda bir çocuk ormanda kaybolmuştu. Ağlıyordu.", illustration: "😢" },
      { title: "Parlama", text: "Küçük yıldız elinden geleni yaptı. En parlak ışığını gönderdi.", illustration: "✨", choices: [
        { label: "Yol göster 🛤️", nextPageIndex: 4 },
        { label: "Sıcaklık ver 🔥", nextPageIndex: 5 },
      ]},
      { title: "Yol", text: "Işığı bir yol oluşturdu. Çocuk o yolu takip etti.", illustration: "🛤️", nextPageIndex: 6 },
      { title: "Isınma", text: "Işığı çocuğa sıcaklık verdi. Çocuk artık üşümüyordu.", illustration: "🔥", nextPageIndex: 6 },
      { title: "Buluşma", text: "Çocuk eve ulaştı. Gökyüzüne baktı ve teşekkür etti.", illustration: "🏠" },
      { title: "Mutlu Son", text: "Küçük yıldız artık yalnız değildi. Bir arkadaşı vardı.", illustration: "🌟" },
    ],
  },
];
