...
import { Trash2, Sparkles, Undo } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap justify-center gap-2 max-w-md">
        {COLORS.map((color) => (
          <button
            ...
            className={`w-10 h-10 md:w-12 md:h-12 rounded-full border-4 transition-all duration-200 hover:scale-125 active:scale-95 ${
              activeColor === color.value && !isRainbow
        ...
        <button
          ...
          className={`w-10 h-10 md:w-12 md:h-12 rounded-full rainbow-gradient border-4 flex items-center justify-center transition-all duration-200 hover:scale-125 active:scale-95 ${
            isRainbow ? 'border-foreground scale-110' : 'border-transparent'
          }`}
          title="Gökkuşağı"
        >
      ...
      <div className="flex gap-3">
        ...
        <button
          onClick={handleClear}
          className="flex items-center gap-2 px-5 py-3 bg-destructive text-destructive-foreground rounded-full font-bold btn-bouncy"
        >
